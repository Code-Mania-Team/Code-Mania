...
accountRouter.post(
  "/signup/request-otp",
  authorization,
  account.requestOtp.bind(account),
);
...
accountRouter.post(
  "/signup/verify-otp",
  authorization,
  account.verifyOtp.bind(account),
);
...
accountRouter.patch(
  ...
  authorization,
  authentication,
  account.updateProfile.bind(account),
);
...
accountRouter.delete(
  ...
  authorization,
  authentication,
  account.deleteUser.bind(account),
);
accountRouter.get(
  "/summary",
  authorization,
  authentication,
  account.getProfileSummary.bind(account),
);
accountRouter.get(
  "/learning-progress",
  authorization,
  authentication,
  account.getLearningProgress.bind(account),
);
