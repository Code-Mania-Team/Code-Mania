  ...
  <>
    <section className="hero-section">
      <div className="hero-content">
        ...
        <Link to="/learn" className="get-started-btn">
          Get Started
        </Link>
      </div>
    </section>
      ...
      <div className="languages-grid">
        <Link to="/learn/python" className="language-card-link">
          <div className="language-card">
            <div className="language-image">
              <img
                src="https://res.cloudinary.com/daegpuoss/image/upload/v1766925755/python_mcc7yl.gif"
                alt="Python"
        ...
        <Link to="/learn/cpp" className="language-card-link">
          <div className="language-card">
            <div className="language-image">
              <img
                src="https://res.cloudinary.com/daegpuoss/image/upload/v1766925753/c_atz4sx.gif"
                alt="C++"
                className="language-img"
              />
            </div>
        ...
        <Link to="/learn/javascript" className="language-card-link">
          <div className="language-card">
            <div className="language-image">
              <img
                src="https://res.cloudinary.com/daegpuoss/image/upload/v1766925754/javascript_esc21m.gif"
                alt="JavaScript"
                className="language-img"
              />
            </div>
    ...
    <section className="learn-section">
      <div className="learn-content">
        <div className="learn-text">
          ...
          <p>
            Embark on an epic journey where programming is your weapon. Complete
            challenges, unlock new skills, and level up as you build real
            projects.
          </p>
        </div>
        <div className="learn-image">
          <img
            src="https://res.cloudinary.com/daegpuoss/image/upload/v1766925761/learntocode_yhnfkd.gif"
            alt="Learn to code"
          />
        </div>
      </div>
      ...
      <div className="learn-content">
        <div className="learn-text">
          ...
          <p>
            Coding is your next adventure. Master quests, earn achievements, and
            progress from beginner to pro while creating powerful applications.
          </p>
        </div>
        <div className="learn-image">
          <img
            src="https://res.cloudinary.com/daegpuoss/image/upload/v1766925753/chill_jnydvb.gif"
            alt="Chill coding"
          />
        </div>
      </div>
      ...
      <div className="learn-content">
        ...
        <div className="learn-image">
          <img
            src="https://res.cloudinary.com/daegpuoss/image/upload/v1766925753/117_jycate.gif"
...
function App() {
  ...
  const setCookie = async () => {
    try {
      ...
      console.log("Error setting up cookies. ");
    }
  };
  // setCookie();
  const getCookies = async () => {
    try {
      ...
      console.log("Error in sending cookies to server.");
    }
  };
  // getCookies();
      ...
      <main className="main-content">
        <Routes>
          ...
          <Route
            ...
            element={<JavaScriptExercise />}
          />
          <Route
            path="/freedomwall"
            element={<FreedomWall onOpenModal={() => setIsModalOpen(true)} />}
          />
          ...
          <Route
            path="/dashboard"
            element={<Dashboard onSignOut={handleSignOut} />}
          />
          <Route path="/admin" element={<Admin />} />
          <Route
            path="/admin/exercises/:course"
