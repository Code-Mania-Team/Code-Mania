...
const swordImage =
  "https://res.cloudinary.com/daegpuoss/image/upload/v1766925752/sword_cnrdam.png";

const shieldImage =
  "https://res.cloudinary.com/daegpuoss/image/upload/v1766925752/shield_ykk5ek.png";

const showPasswordIcon =
  "https://res.cloudinary.com/daegpuoss/image/upload/v1766925753/view_yj1elw.png";

const hidePasswordIcon =
  "https://res.cloudinary.com/daegpuoss/image/upload/v1766925754/hide_apyeec.png";
    ...
    try {
      ...
      if (!showForgotPasswordOtp && !showResetPassword) {
        ...
        const response = await axiosPublic.post(
          "/v1/forgot-password/request-otp",
          { email },
        );
