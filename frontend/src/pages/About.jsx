...
const laptopImg =
  "https://res.cloudinary.com/daegpuoss/image/upload/v1770949053/laptop1_ejnkeg.png";
    ...
    <div className="about-page">
      <section className="about-section">
        ...
        <div className="about-text">
          ...
          <p>
            CodeMania is more than just a tutorial site; it transforms debugging
            into leveling up. Journey through Python, C++, and JavaScript.
          </p>
      ...
      <section className="info-container">
        <div className="info-box">
          ...
          <ul>
            <li>
              <strong>Engagement First:</strong> Interactive challenges.
            </li>
            <li>
              <strong>Built for Freshmen:</strong> Learn by playing.
            </li>
            <li>
              <strong>Learn by Doing:</strong> Write real code.
            </li>
          </ul>
        </div>
      </section>
