...
const profileBanner =
  "https://res.cloudinary.com/daegpuoss/image/upload/v1770453646/profile-banner_wuyk83.jpg";
  ...
  useEffect(() => {
    const loadProfile = async () => {
      ...
      setEditFormData((prev) => {
        const displayUsername = nextUsername
          ? `@${nextUsername}`
          : prev.username;
      ...
      <div className={styles.coverBanner}>
        ...
        <div className={styles.coverOverlay}>
          <div className={styles.coverOverlayInner}>
            ...
            <button
              className={styles.coverEditProfileBtn}
                ...
                {badges.length === 0 ? (
                  ...
                  >
                    ...
                    <p style={{ fontSize: "14px", marginTop: "8px" }}>
                      Complete exercises to unlock badges!
                    </p>
                  </div>
                ) : (
                  <>
                      ...
                      <div key={badge.id} className={styles.tableRow}>
                        <div className={styles.badgeCell}>
                          <img
                            ...
                            src={
                              (badge.badgeKey &&
                                badgeImageByKey[badge.badgeKey]) ||
            ...
            {activeTab === "learningProgress" && (
              <div className={styles.learningProgressContainer}>
                ...
                <div className={styles.progressGrid}>
                  {Object.entries(learningProgress).map(
                    ([language, { progress, total, icon }]) => (
          ...
          <div className={styles.sidebarCard}>
            ...
            <div className={styles.sidebarCardStatRow}>
              <div className={styles.sidebarCardStat}>
                <div className={styles.sidebarCardStatValue}>
                  {totalXp || 0}
                </div>
