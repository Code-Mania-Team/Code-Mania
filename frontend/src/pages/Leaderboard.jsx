...
const leaderboardBg =
  "https://res.cloudinary.com/daegpuoss/image/upload/v1766925761/leaderboard_fryema.gif";
const trophyIcon =
  "https://res.cloudinary.com/daegpuoss/image/upload/v1766925752/trophy_tho3vz.png";
    ...
    const fetchLeaderboard = async () => {
      try {
        ...
        let users = response.data.map((user) => ({
          ...user,
          selectedXP:
            activeTab === "all" ? user.overall_xp : user[`${activeTab}_xp`],
        }));
